                        ...
                        <div class="page-wrapper">
                            <div class="blog-title-area text-center">
                                ...
                                <div class="blog-meta big-meta">
                                    ...
                                    <small><a href="tech-author.html" title=""><?php echo $row['sliders_author'] ?></a></small>
                            ...
                            <div class="single-post-media">
                                <img src="nedmin/dimg/sliders/<?php echo $row['sliders_file'] ?>" alt="nedmin/dimg/sliders/<?php echo $row['sliders_file'] ?>" class="img-fluid">
                            </div><!-- end media -->
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <h4><a href="#"><?php echo $row['sliders_author'] ?></a></h4>
